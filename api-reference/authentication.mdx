...
The sondos-ai API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your sondos-ai account at [https://app.siyadah-ai.tn](https://app.siyadah-ai.tn)
...
```bash
curl -X GET "https://api.siyadah-ai.tn/api/user/campaigns" \
