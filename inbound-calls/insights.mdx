...
After an inbound call, sondes-ai.com provides transcripts, analytics, and possible automation triggers.
...
- In your sondes-ai.com dashboard, go to **Calls** or **History**.
