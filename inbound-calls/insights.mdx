...
After an inbound call, siyadah-ai.tn provides transcripts, analytics, and possible automation triggers.
...
- In your siyadah-ai.tn dashboard, go to **Calls** or **History**.
