...
After an inbound call, sondos-ai.ai provides transcripts, analytics, and possible automation triggers.
...
- In your sondos-ai.ai dashboard, go to **Calls** or **History**.
