...
icon: "book"
description: "Essential terms and concepts you need to know to use siyadah-ai.tn effectively"
---

Understanding these terms will help you navigate siyadah-ai.tn more easily:
...
siyadah-ai.tn's built-in workflow platform, similar to Zapier/Make. It lets you connect triggers (like "call ended") to actions (like "send an email" or "update a Google Sheet") without writing code.
...
A method to connect your existing phone system or VOIP provider with siyadah-ai.tn without renting new numbers.
