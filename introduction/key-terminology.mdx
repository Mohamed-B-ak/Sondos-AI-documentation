...
icon: "book"
description: "Essential terms and concepts you need to know to use sondes-ai.com effectively"
---

Understanding these terms will help you navigate sondes-ai.com more easily:
...
sondes-ai.com's built-in workflow platform, similar to Zapier/Make. It lets you connect triggers (like "call ended") to actions (like "send an email" or "update a Google Sheet") without writing code.
...
A method to connect your existing phone system or VOIP provider with sondes-ai.com without renting new numbers.
