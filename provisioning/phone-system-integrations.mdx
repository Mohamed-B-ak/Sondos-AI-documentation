...
icon: "phone-office"
description: "Learn how to integrate sondos-ai.ai with your existing PBX or VOIP infrastructure through SIP trunks"
---

For businesses with existing PBX or VOIP infrastructure, sondos-ai.ai can integrate through SIP trunks or direct connections:

## 1. SIP Trunk

- **How It Works**: You share your SIP credentials (server, username, password). sondos-ai.ai configures a trunk internally.
...
- If your PBX already handles call routing, pass the call to sondos-ai.ai only when certain conditions are met (like after IVR selection).
...
- Carrier charges from your PBX provider still apply, plus any sondos-ai.ai usage fees.
