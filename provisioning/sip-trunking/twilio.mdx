...
{/* - If you opt for the auth route, you need to specify the username and password in the next step when importing the number to sondos-ai.
   <Frame>
     <img
...
- Currently sondos-ai SIP server does not have a static IP, so if you opt for the IP route, you need to whitelist all the IP addresses in the range like following:
...
- Here you will specify sondos-ai SIP server address as the origination SIP URI: ```sip:5wed79aeavr.sip.livekit.cloud ``` 
...
## Step 3: Import numbers to sondos-ai

Now the number is set up with your elastic SIP trunking, you need to import the number to sondos-ai so that we will know how to route the call.
...
3. Click “Integrate SIP trunk”
   ...
   <Frame>
     <img
       src="/resources/twillio-import-sondos-ai-sip1.png"
       alt="Import numbers to sondos-ai"
     />
   </Frame>
...
```
   <Frame>
     <img
       src="/resources/twillio-sondos-ai-auth-integration.png"
...
{/* - If you opted for auth route select Username and password.
   ...
   <Frame>
     <img
       src="/resources/twillio-sondos-ai-credentials-auth-type.png"
       alt="Twillio sondos-ai Credentials Auth Type"
     />
   </Frame> */}
...
```
   <Frame>
     <img
       src="/resources/twillio-sondos-ai-credentials-ip-type1.png"
       alt="Twillio sondos-ai Credentials IP Type"
     />
   </Frame> 
...
7. Select the country of where your SIP trunk is located. 
    ...
    <Frame>
      <img
        src="/resources/twillio-sondos-ai-sip-country.png"
        alt="Twillio sondos-ai SIP Country"
      />
    </Frame>
