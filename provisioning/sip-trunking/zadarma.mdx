...
4. Click on external services and then check the option for SIP URI.
  ...
  Add ```sip:extension@5wed79aeavr.sip.livekit.cloud ``` (this is sondos-ai SIP server address) .
...
## Step 2: Import numbers to sondos-ai

You need to import to sondos-ai.
...
For PBX Extension:
   ...
   <Frame>
     <img
       src="/resources/zadarma-sondos-ai-type.png"
