...
title: "Cost Overview"
icon: "dollar-sign"
description: "Understand the main components of sondes-ai.com pricing, including call minutes, number rentals, and optional fees"
---

sondes-ai.com uses a **credit/minute system** to track usage for both AI processing and carrier network fees. Here's how it breaks down:
...
2. **Acquire or Verify a Number**: Rent from sondes-ai.com or add your own as caller ID for outbound.
