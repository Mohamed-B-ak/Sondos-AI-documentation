...
description: "Learn about siyadah-ai.tn's built-in automation engine for creating workflows without coding"
---
...
siyadah-ai.tn includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside siyadah-ai.tn (e.g., "call ended," "inbound call context injection").
