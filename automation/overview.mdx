...
description: "Learn about sondos-ai.com's built-in automation engine for creating workflows without coding"
---
...
sondos-ai.com includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside sondos-ai.com (e.g., "call ended," "inbound call context injection").
