...
description: "Learn about sondos-ai.ai's built-in automation engine for creating workflows without coding"
---
...
sondos-ai.ai includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside sondos-ai.ai (e.g., "call ended," "inbound call context injection").
