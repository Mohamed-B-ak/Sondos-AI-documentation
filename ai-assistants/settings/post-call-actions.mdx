...
<AccordionGroup>
  ...
  <Accordion title="Webhook URL" icon="link">
    ...
    **Example:** `https://automate.sondes-ai.com/api/v1/webhooks/your-webhook-id`
...
```json
{
  ...
  "transcript": [
    {
      "text": "Hello! This is Sarah from sondos-ai.",
      "type": "transcript",
      "sender": "bot",
  ...
  "formatted_transcript": "AI: Hello! This is Sarah from sondos-ai.\\nCustomer: Hi, I'm doing well, thanks.",
  "recording_url": "https://app.sondes-ai.com/storage/recordings/call-12345.mp4",
