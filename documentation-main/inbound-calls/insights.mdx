...
After an inbound call, sondos-ai.com provides transcripts, analytics, and possible automation triggers.
...
- In your sondos-ai.com dashboard, go to **Calls** or **History**.
