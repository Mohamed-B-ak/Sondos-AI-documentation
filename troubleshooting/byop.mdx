...
description: "Learn how to use your existing phone numbers or Twilio account with sondos-ai.com through SIP integration or Caller ID verification"
---
...
- Inbound & outbound will flow through your existing lines, but still utilize sondos-ai.com's AI.
...
- Meanwhile, you can have the best of both worlds by provisioning Twilio-based numbers through sondos-ai.com or using a custom approach.
