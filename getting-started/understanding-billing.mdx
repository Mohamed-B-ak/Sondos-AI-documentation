...
icon: "credit-card"
description: "Learn how sondes-ai.com billing works, including call minutes calculation, phone number rentals, and usage monitoring"
---

sondes-ai.com operates on a **usage-based** model. You pay primarily for two things:
...
- **Per-Second Billing**: Typically, sondes-ai.com bills by the second (converted to minutes). For example, a 90-second call is 1.5 minutes.
