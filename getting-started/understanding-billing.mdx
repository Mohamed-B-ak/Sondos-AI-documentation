...
icon: "credit-card"
description: "Learn how siyadah-ai.tn billing works, including call minutes calculation, phone number rentals, and usage monitoring"
---

siyadah-ai.tn operates on a **usage-based** model. You pay primarily for two things:
...
- **Per-Second Billing**: Typically, siyadah-ai.tn bills by the second (converted to minutes). For example, a 90-second call is 1.5 minutes.
