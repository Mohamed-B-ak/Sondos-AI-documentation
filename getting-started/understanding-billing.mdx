...
icon: "credit-card"
description: "Learn how sondos-ai.ai billing works, including call minutes calculation, phone number rentals, and usage monitoring"
---

sondos-ai.ai operates on a **usage-based** model. You pay primarily for two things:
...
- **Per-Second Billing**: Typically, sondos-ai.ai bills by the second (converted to minutes). For example, a 90-second call is 1.5 minutes.
